...
class Signup extends Component {
  ...
  render() {
    ...
    return(
      <div>
        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#exampleModalCenter2"><img class="signup-picture" src="http://nitinfire.com/skin/frontend/megatron/default/images/large-icon-user.png"/>Sign Up</button>
